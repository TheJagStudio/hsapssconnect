			...
			<div className="fixed bottom-0 md:bottom-3 left-0 md:left-1/2 translate-x-0 md:-translate-x-1/2 rounded-t-3xl md:rounded-full grid grid-cols-5 items-center justify-center w-screen md:w-[50%] lg:w-[40%] h-18 py-3 z-40 bg-white md:bg-white/80 md:backdrop-blur-lg custom-shadow lg:shadow-xl overflow-x-hidden">
				...
				>
					{currentPage == "home" ? (
						...
						<svg
							className="w-6 h-6 text-primary-700 opacity-80"
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 576 512"
						>
							<path
				...
				>
					{currentPage == "bhajan" ? (
						...
						>
							<path
								fill="currentColor"
								d="M512 23c0-12.7-10.3-23-23-23c-2.3 0-4.6 .3-6.8 1l-311 95.7C164.6 98.8 160 105 160 112l0 120 0 140.4C143 359.7 120.6 352 96 352c-53 0-96 35.8-96 80s43 80 96 80s96-35.8 96-80l0-185.7 288-88.6 0 150.7c-17-12.7-39.4-20.4-64-20.4c-53 0-96 35.8-96 80s43 80 96 80s96-35.8 96-80l0-231.6c0-.2 0-.5 0-.7L512 23zM480 368c0 21.3-22.9 48-64 48s-64-26.7-64-48s22.9-48 64-48s64 26.7 64 48zM160 432c0 21.3-22.9 48-64 48s-64-26.7-64-48s22.9-48 64-48s64 26.7 64 48zM480 124.2L192 212.8l0-89L480 35.2l0 89z"
							/>
						</svg>
					)}
					<p
				...
				>
					{currentPage == "books" ? (
						...
						>
							<path
								fill="currentColor"
								d="M96 0C43 0 0 43 0 96L0 416c0 53 43 96 96 96l288 0 32 0 32 0 0-64-32 0 0-64 32 0L448 0 416 0 384 0 96 0zm0 384l256 0 0 64L96 448c-17.7 0-32-14.3-32-32s14.3-32 32-32zm32-256l224 0 0 32-224 0 0-32zm224 64l0 32-224 0 0-32 224 0z"
							/>
						</svg>
					) : (
						<svg
